            ...
            <View style={{flex:0.3, justifyContent: 'center', alignItems:'center'}}>
            {
                ...
                ?(
                    ...
                    navigation={this.props.navigation}
                        onPress={()=>{
                        db.collection('Barter_Items').doc(this.state.RequestDocId).delete().then(function(){
                            alert("Your request for this item has been deleted. It will not appear on your home page the next time you login.")
